...
export const pt: Record<string, string> = {
  ...
  'field.attackSize': 'Ataque inicial %',
  'field.seed': 'Semente (opcional)',
  'field.seedPlaceholder': 'vazio = aleatória',
  'field.reroll': 'Rolar',
  'preset.title': 'Configurações',
  'preset.sub': '{ai} rivais · {wild} selvagens',
  ...
  'play.matchSettings': 'Ajustar configurações da partida',
  ...
  'settings.hud.hint':
    'Todo o HUD pode ser personalizado livremente durante a partida — prime Esc no jogo e escolhe «Personalizar HUD»: move, redimensiona, mostra ou oculta painéis.',
  ...
  // Classificação online (ADR-0027)
  'ranking.title': 'Classificação online',
  'ranking.intro':
    'O teu ELO de classificação de partidas a solo contra a IA, guardado globalmente. As partidas multijogador não o alteram.',
  'ranking.myElo': 'O teu ELO',
  'ranking.myPeak': 'Recorde',
  'ranking.loading': 'A carregar …',
  'ranking.empty': 'Nenhuma entrada ainda — joga uma partida ranqueada!',
  'ranking.offline': 'Offline — não foi possível contactar o servidor de classificação.',
  'ranking.colName': 'Nome',
  'ranking.colElo': 'ELO',
  'ranking.colRecord': 'V/D',
  'ranking.hideMe': 'Ocultar-me da classificação',
  'ranking.hidden': 'Oculto',
  'ranking.visible': 'Visível',

  // Conta / início de sessão (ADR-0027 fase 2)
  'account.signIn': 'Entrar',
  'account.title.account': 'Conta',
  'account.title.login': 'Entrar',
  'account.title.register': 'Criar conta',
  'account.title.recover': 'Redefinir senha',
  'account.loggedInAs': 'Conectado como {name}',
  'account.intro':
    'Opcional: salve o seu ELO em todos os seus dispositivos. Sem conta continuas a jogar como convidado.',
  'account.username': 'Nome de utilizador',
  'account.password': 'Senha',
  'account.newPassword': 'Nova senha',
  'account.email': 'E-mail (opcional)',
  'account.recoveryCode': 'Código de recuperação',
  'account.btn.login': 'Entrar',
  'account.btn.register': 'Criar conta',
  'account.btn.recover': 'Redefinir',
  'account.btn.logout': 'Sair',
  'account.btn.close': 'Fechar',
  'account.btn.savedIt': 'Já guardei',
  'account.btn.deleteAccount': 'Eliminar conta',
  'account.btn.privacy': 'Privacidade',
  'account.btn.back': 'Voltar',
  'account.switch.toRegister': 'Ainda não tem conta? Crie uma',
  'account.switch.toLogin': 'Já tem conta? Entrar',
  'account.switch.toRecover': 'Esqueceu a senha?',
  'account.recoveryTitle': 'O seu código de recuperação',
  'account.recoveryHint':
    'Guarde-o em local seguro — é a única forma de redefinir a sua senha sem e-mail. É mostrado apenas esta vez.',
  'account.error.invalid': 'Nome de utilizador ou senha incorretos.',
  'account.error.taken': 'Esse nome de utilizador já está em uso.',
  'account.error.username': 'Nome de utilizador: 3–24 caracteres (letras, dígitos, _ e -).',
  'account.error.password': 'Senha: pelo menos 6 caracteres.',
  'account.error.offline': 'Servidor indisponível.',
  'account.delete.title': 'Eliminar conta?',
  'account.delete.warning':
    'Isto elimina permanentemente a tua conta e todos os dados associados (nome de exibição, classificação ELO e historial, definições guardadas) do servidor. Esta ação não pode ser desfeita.',
  'account.delete.passwordPrompt': 'Introduz a senha para confirmar',
  'account.delete.confirm': 'Eliminar definitivamente',
  'account.delete.cancel': 'Cancelar',
  'account.delete.wrongPassword': 'Senha incorreta.',
  'account.delete.done': 'Conta eliminada. Agora jogas novamente como convidado anónimo.',
  'account.privacy.title': 'Privacidade',
  'account.privacy.body':
    'Para a classificação online, este jogo armazena apenas o essencial: o teu nome de exibição, a tua classificação ELO e o teu historial. Se criares uma conta, são adicionados um nome de utilizador, uma senha cifrada e — apenas se a indicares — um endereço de e-mail; as tuas definições entre dispositivos são então também guardadas na conta. Sem publicidade, sem rastreamento, sem partilha com terceiros. Podes eliminar a tua conta a qualquer momento através da opção acima. Questões ou pedidos de acesso/eliminação: {email}',

  // Tutorial (partida guiada)
  'tutorial.title': 'Tutorial',
  'tutorial.btn.next': 'Próximo',
  'tutorial.btn.finish': 'Concluído',
  'tutorial.step.welcome.goal': 'Bem-vindo',
  'tutorial.step.welcome.text':
    'Bem-vindo ao territorial-loop! O território colorido no centro é o teu reino. O teu objetivo: expandires-te e conquistares a ilha. Vamos percorrer as bases passo a passo.',
  'tutorial.step.expand.goal': 'Expande-te',
  ...
  'tutorial.step.city.goal': 'Constrói uma cidade',
  'tutorial.step.city.text':
    'Com ouro constróis edifícios. Damos-te algum ouro para praticares. Prime a tecla 1 e coloca uma cidade no teu território — uma cidade aumenta o teu limite de tropas, podendo assim ter mais.',
  'tutorial.step.factory.goal': 'Constrói uma fábrica',
  'tutorial.step.factory.text':
    'O ouro é a chave de tudo. Constrói uma fábrica (tecla 4) — ela liga-se às tuas cidades e produz ouro continuamente. As fábricas são a espinha dorsal da tua economia. Aqui tens ouro para isso.',
  'tutorial.step.grow.goal': 'Continua a crescer',
  'tutorial.step.grow.text':
    'Excelente! Crescer é o mais importante. Continua a expandir-te e a conquistar mais território — quanto maior o teu reino, mais tropas e ouro terás.',
  'tutorial.step.airport.goal': 'Constrói um aeroporto',
  'tutorial.step.airport.text':
    'Hora do poder aéreo. Constrói um aeroporto (tecla 5) — é daqui que partem os bombardeiros. Damos-te o ouro para isso.',
  'tutorial.step.bomber.goal': 'Lança um bombardeiro',
  'tutorial.step.bomber.text':
    'Prime a tecla 7 para construir um bombardeiro e depois clica num território inimigo (cinzento). O bombardeiro voa até lá e lança uma bomba que mata tropas, neutraliza território e destrói edifícios — cuidado, não poupa ninguém, nem mesmo os aliados.',
  'tutorial.step.finish.goal': 'Concluído',
  'tutorial.step.finish.text':
    'Conseguiste! Dominas os fundamentos: expandires-te, conquistar, a economia (cidades + fábricas) e a guerra aérea. Portos e navios, diplomacia e os modos de jogo aprendes melhor diretamente numa partida real. Boa sorte!',
  ...
  'event.capitalCaptured': '{p} conquista a capital de {victim} e toma o seu império',
  'event.capitalBombed': 'A capital de {victim} está destruída — o seu império retorna à selva',
  ...
  'keybind.center': 'Centrar na tua nação',
  'keybind.radial': 'Abrir menu de ações',
  'keybind.boat': 'Modo barco de transporte',
  'keybind.bomber': 'Modo bombardeiro',
  'keybind.warship': 'Modo navio de guerra',
  'keybind.shipRanges': 'Mostrar alcances dos navios',
  'keybind.speedUp': 'Aumentar velocidade',
  'keybind.speedDown': 'Reduzir velocidade',
  'keybind.buildCity': 'Construir: Cidade',
  'keybind.buildDefense': 'Construir: Defesa',
  'keybind.buildPort': 'Construir: Porto',
  'keybind.buildFactory': 'Construir: Fábrica',
  'keybind.buildAirport': 'Construir: Aeroporto',
  'keybind.buildFlak': 'Construir: Antiaérea',
  ...
  'hud.editor.slider': 'Deslizador',
  'hud.editor.slider.action': 'Ações',
  'hud.editor.slider.resource': 'Tropas',
  'hud.editor.buttons': 'Botões',
  'hud.editor.buttons.row': 'Fileiras',
  'hud.editor.buttons.numpad': 'Numpad',
  'hud.editor.merged': 'Bloco',
  'hud.editor.split': 'Dividido',
  'hud.editor.panel.troopsNum': 'Número de tropas',
  'hud.editor.panel.troopsBar': 'Barra de tropas',
  'hud.editor.panel.gold': 'Ouro',
  'hud.editor.panel.buys': 'Compras',
  'hud.editor.panel.boat': 'Barco de transporte',
  'hud.editor.theme': 'Tema',
  'hud.editor.hidden': 'Oculto',
  'hud.editor.elements': 'Elementos',
  'hud.editor.tab.layout': 'Disposição',
  'hud.editor.quickConfig': 'Config. rápida',
  'quickcfg.standard': 'Padrão',
  'quickcfg.mouse': 'Rato',
  'quickcfg.wheel': 'Roda de nav.',
  'hud.editor.presets.templates': 'Modelos',
  'hud.editor.presets.custom': 'Personalizados',
  'hud.editor.presets.load': 'Carregar',
  'hud.editor.presets.save': 'Guardar',
  'hud.editor.presets.delete': 'Eliminar',
  'hud.editor.presets.slotName': 'Disposição {n}',
  'hud.editor.presets.namePlaceholder': 'Nome…',
  'hud.editor.presets.reset': 'Repor',
  'hud.editor.presets.saveInto': 'Guardar em…',
  'hud.editor.presets.newSlot': 'Nova entrada',
  'hud.editor.panel.attacks': 'Ataques em curso',
  'hud.editor.emptyHint': 'aparece na partida',
  'hud.editor.hint': 'Arrastar = mover · Cantos = redimensionar · × = ocultar',
  'hud.editor.resizePanel': 'Redimensionar a barra de ferramentas',
  'hud.editor.panel.info': 'Tempo de jogo',
  'hud.editor.panel.rank': 'Classificação',
  'hud.editor.panel.resource': 'Tropas e construção',
  'hud.editor.panel.action': 'Barra de ações',
  'hud.editor.panel.minimap': 'Minimapa',
  'hud.editor.panel.feed': 'Mensagens',
  'hud.editor.panel.wheel': 'Roda de ação',
  'hud.editor.panel.topbar': 'Barra de estado',
  'hud.editor.panel.attackbar': 'Tamanho do ataque',
  'hud.editor.panel.menu': 'Botão de menu',
  'hud.editor.panel.feedback': 'Botão de feedback',
  'hud.editor.troopStyle': 'Exibição de tropas',
  'hud.editor.troopStyle.bar': 'Barra',
  'hud.editor.troopStyle.orb': 'Orbe',
  'hud.editor.control': 'Controlos',
  'hud.editor.control.auto': 'Auto',
  'hud.editor.control.desktop': 'Desktop',
  'hud.editor.control.touch': 'Rato / Roda',
  ...
  'wheel.ships': 'Ataques',
  'minimap.collapse': 'Recolher minimapa',
  'minimap.expand': 'Expandir minimapa',
  ...
  'menu.donateGold': 'Doar ouro',
  'menu.donateGoldParent': 'Ganhar simpatia / aplacar rancor',
  'menu.donateGoldDetail': 'Doa {n} de ouro',
  'menu.donateSlider': 'Valor do controle',
  'menu.donateTroops': 'Doar tropas',
  'menu.donateTroopsDetail': 'Envia {n} tropas de apoio',
