...
export const pt: Record<string, string> = {
  ...
  'field.camera': 'Câmera',
  'field.hoverMode': 'Info ao passar',
  'field.master': 'Geral',
  ...
  'hovermode.both': 'Painel + tooltip',
  'hovermode.panel': 'Somente painel fixo',
  'hovermode.tooltip': 'Somente tooltip do cursor',
  'field.mapStyle': 'Estilo do mapa',
  ...
  'settings.commandBar': 'Barra de comando RTS (embaixo)',
  'hud.editor.toBar': 'Para a barra',
  'hud.editor.fromBar': 'Fora da barra',
  ...
  'citystage.dorf': 'Aldeia',
  'citystage.kleinstadt': 'Vila',
  'citystage.stadt': 'Cidade',
  'citystage.grossstadt': 'Grande cidade',
  'citystage.metropole': 'Metrópole',
  'citystage.weltstadt': 'Cidade mundial',
