...
export const ja: Record<string, string> = {
  ...
  'hovermode.both': 'パネル＋ツールチップ',
  'hovermode.panel': '固定パネルのみ',
  'hovermode.tooltip': 'カーソルツールチップのみ',
  'field.mapStyle': 'マップスタイル',
  'mapstyle.standard': '標準',
  'mapstyle.atlas': 'アトラス',
  'mapstyle.flat': 'ミニマル',
  ...
  // アカウント / ログイン（ADR-0027 フェーズ 2）
  'account.signIn': 'ログイン',
  'account.title.account': 'アカウント',
  'account.title.login': 'ログイン',
  'account.title.register': 'アカウント作成',
  'account.title.recover': 'パスワードのリセット',
  'account.loggedInAs': '{name} としてログイン中',
  'account.intro':
    '任意：ELO をデバイス間で保存できます。アカウントなしでもゲストとしてプレイ続行できます。',
  'account.username': 'ユーザー名',
  'account.password': 'パスワード',
  'account.newPassword': '新しいパスワード',
  'account.email': 'メールアドレス（任意）',
  'account.recoveryCode': '回復コード',
  'account.btn.login': 'ログイン',
  'account.btn.register': 'アカウント作成',
  'account.btn.recover': 'リセット',
  ...
  'account.recoveryTitle': 'あなたの回復コード',
  'account.recoveryHint':
    '安全な場所に保管してください —— メールなしでパスワードをリセットできる唯一の方法です。表示されるのはこの一度限りです。',
  'account.error.invalid': 'ユーザー名またはパスワードが正しくありません。',
  'account.error.taken': 'そのユーザー名はすでに使用されています。',
  ...
  'tutorial.step.size.text':
    'Shift+マウスホイールで攻撃に投入する兵力を調整できます。兵力が多いほど速く征服できますが、中心領土が手薄になります。気軽に試してみましょう。',
  ...
  'keybind.center': '自国にカメラを合わせる',
  'keybind.radial': 'アクションメニューを開く',
  'keybind.boat': '輸送艇モード',
  'keybind.bomber': '爆撃機モード',
  'keybind.warship': '軍艦モード',
  'keybind.shipRanges': '船の範囲を表示',
  'keybind.speedUp': '速度を上げる',
  'keybind.speedDown': '速度を下げる',
  'keybind.buildCity': '建設：都市',
  'keybind.buildDefense': '建設：防衛',
  'keybind.buildPort': '建設：港',
  'keybind.buildFactory': '建設：工場',
  'keybind.buildAirport': '建設：空港',
  'keybind.buildFlak': '建設：対空',
  ...
  'hud.editor.tab.layout': 'レイアウト',
  'hud.editor.quickConfig': 'クイック設定',
  'quickcfg.standard': '標準',
  'quickcfg.mouse': 'マウス',
  ...
  'hud.editor.presets.namePlaceholder': '名前…',
  'hud.editor.presets.reset': 'リセット',
  'hud.editor.presets.saveInto': '保存先…',
  'hud.editor.presets.newSlot': '新しいスロット',
  'hud.editor.panel.attacks': '進行中の攻撃',
  'hud.editor.emptyHint': 'ゲーム中に表示',
  'hud.editor.hint': 'ドラッグ = 移動 · 角 = リサイズ · × = 非表示',
  'hud.editor.resizePanel': 'ツールバーのサイズを変更',
  'hud.editor.panel.info': 'ゲーム時間',
  'hud.editor.panel.rank': 'ランキング',
  'hud.editor.panel.resource': '兵力と建設',
  'hud.editor.panel.action': 'アクションバー',
  'hud.editor.panel.minimap': 'ミニマップ',
  'hud.editor.panel.feed': 'メッセージ',
  'hud.editor.panel.wheel': 'アクションホイール',
  'hud.editor.panel.topbar': 'ステータスバー',
  'hud.editor.panel.attackbar': '攻撃規模',
  'hud.editor.panel.menu': 'メニューボタン',
  'hud.editor.panel.feedback': 'フィードバックボタン',
  'hud.editor.troopStyle': '兵力表示',
  'hud.editor.troopStyle.bar': 'バー',
  'hud.editor.troopStyle.orb': '球体',
  'hud.editor.control': '操作モード',
  'hud.editor.control.auto': '自動',
  'hud.editor.control.desktop': 'デスクトップ',
  'hud.editor.control.touch': 'マウス / ホイール',
  'hud.boat': '輸送艇',
  'hud.bomber': '爆撃機',
  'hud.warship': '軍艦',
  ...
  'wheel.build': '建設',
  'wheel.ships': '攻撃',
  'minimap.collapse': 'ミニマップを折りたたむ',
  'minimap.expand': 'ミニマップを展開する',
