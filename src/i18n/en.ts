...
export const en: Record<string, string> = {
  ...
  'play.matchSettings': 'Adjust match settings',
  ...
  'ranking.offline': 'Offline — can’t reach the ranking server.',
  ...
  'hud.editor.presets.reset': 'Reset',
