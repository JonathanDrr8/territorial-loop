...
export const it: Record<string, string> = {
  ...
  'nav.help': 'Aiuto',
  'nav.short.play': 'Gioca',
  'nav.short.multiplayer': 'Online',
  'nav.short.ranking': 'Rango',
  'nav.short.settings': 'Opzioni',
  'nav.short.changelog': 'Novità',
  'nav.short.help': 'Aiuto',
  ...
  'field.captureMode': 'Modalità capitale',
  'field.teamMode': 'Squadre',
  'teamMode.off': 'No (tutti contro tutti)',
  'teamMode.allied': 'Squadre (alleate)',
  'teamMode.shared': 'Nazione condivisa',
  'field.teamCount': 'Numero di squadre',
  'field.teamSize': 'Dimensione squadra',
  ...
  'preset.title': 'Configurazioni',
  'preset.sub': '{ai} avversari · {wild} selvaggi',
  'preset.small': 'Piccola',
  ...
  'play.matchSettings': 'Modifica le impostazioni della partita',
  ...
  'field.hoverMode': 'Info al passaggio',
  ...
  // Classifica online (ADR-0027)
  'ranking.title': 'Classifica online',
  'ranking.intro':
    'Il tuo ELO di classifica dalle partite in solitaria contro l’IA, salvato nel mondo. Le partite multigiocatore non lo modificano.',
  'ranking.myElo': 'Il tuo ELO',
  'ranking.myPeak': 'Record',
  'ranking.loading': 'Caricamento …',
  'ranking.empty': 'Nessuna voce ancora — gioca una partita classificata!',
  'ranking.offline': 'Offline — impossibile raggiungere il server della classifica.',
  'ranking.colName': 'Nome',
  'ranking.colElo': 'ELO',
  'ranking.colRecord': 'V/S',
  'ranking.hideMe': 'Nascondimi dalla classifica',
  'ranking.hidden': 'Nascosto',
  'ranking.visible': 'Visibile',

  // Account / accesso (ADR-0027 fase 2)
  'account.signIn': 'Accedi',
  'account.title.account': 'Account',
  'account.title.login': 'Accedi',
  'account.title.register': 'Crea account',
  'account.title.recover': 'Reimposta password',
  'account.loggedInAs': 'Connesso come {name}',
  'account.intro':
    'Facoltativo: salva il tuo ELO su tutti i dispositivi. Senza account continui a giocare come ospite.',
  'account.username': 'Nome utente',
  'account.password': 'Password',
  'account.newPassword': 'Nuova password',
  'account.email': 'E-mail (facoltativa)',
  'account.recoveryCode': 'Codice di recupero',
  'account.btn.login': 'Accedi',
  'account.btn.register': 'Crea account',
  'account.btn.recover': 'Reimposta',
  'account.btn.logout': 'Esci',
  'account.btn.close': 'Chiudi',
  'account.btn.savedIt': "L'ho salvato",
  'account.btn.deleteAccount': 'Elimina account',
  'account.btn.privacy': 'Privacy',
  'account.btn.back': 'Indietro',
  'account.switch.toRegister': 'Non hai un account? Creane uno',
  'account.switch.toLogin': 'Hai già un account? Accedi',
  'account.switch.toRecover': 'Hai dimenticato la password?',
  'account.recoveryTitle': 'Il tuo codice di recupero',
  'account.recoveryHint':
    "Conservalo in un posto sicuro — è l'unico modo per reimpostare la password senza e-mail. Viene mostrato solo questa volta.",
  'account.error.invalid': 'Nome utente o password errati.',
  'account.error.taken': 'Questo nome utente è già in uso.',
  'account.error.username': 'Nome utente: 3–24 caratteri (lettere, cifre, _ e -).',
  'account.error.password': 'Password: almeno 6 caratteri.',
  'account.error.offline': 'Server non raggiungibile.',
  'account.delete.title': "Eliminare l'account?",
  'account.delete.warning':
    'Questa operazione elimina definitivamente il tuo account e tutti i dati correlati (nome visualizzato, classifica ELO e storico, impostazioni salvate) dal server. Non è possibile annullare questa azione.',
  'account.delete.passwordPrompt': 'Inserisci la password per confermare',
  'account.delete.confirm': 'Elimina definitivamente',
  'account.delete.cancel': 'Annulla',
  'account.delete.wrongPassword': 'Password errata.',
  'account.delete.done': 'Account eliminato. Ora giochi di nuovo come ospite anonimo.',
  'account.privacy.title': 'Privacy',
  'account.privacy.body':
    "Per la classifica online, questo gioco memorizza solo l'essenziale: il tuo nome visualizzato, il tuo punteggio ELO e il tuo storico. Se crei un account, vengono aggiunti un nome utente, una password cifrata e — solo se la fornisci — un indirizzo e-mail; anche le tue impostazioni tra dispositivi vengono salvate nell'account. Nessuna pubblicità, nessun tracciamento, nessuna condivisione con terze parti. Puoi eliminare il tuo account in qualsiasi momento dalla sezione sopra. Domande o richieste di accesso/cancellazione: {email}",

  // Tutorial (partita guidata)
  'tutorial.title': 'Tutorial',
  'tutorial.btn.next': 'Avanti',
  'tutorial.btn.finish': 'Fatto',
  'tutorial.step.welcome.goal': 'Benvenuto',
  'tutorial.step.welcome.text':
    "Benvenuto in territorial-loop! Il territorio colorato al centro è il tuo regno. Il tuo obiettivo: espanderti e conquistare l'isola. Percorreremo le basi passo dopo passo.",
  'tutorial.step.expand.goal': 'Espanditi',
  ...
  'tutorial.step.city.goal': 'Costruisci una città',
  'tutorial.step.city.text':
    "Con l'oro costruisci edifici. Ti diamo un po' d'oro per fare pratica. Premi il tasto 1 e posiziona una città sul tuo territorio — una città aumenta il tuo limite di truppe, così puoi tenerne di più.",
  'tutorial.step.factory.goal': 'Costruisci una fabbrica',
  'tutorial.step.factory.text':
    "L'oro è la chiave di tutto. Costruisci una fabbrica (tasto 4) — si collega alle tue città e produce oro in modo continuo. Le fabbriche sono il pilastro della tua economia. Ecco dell'oro per farlo.",
  'tutorial.step.grow.goal': 'Continua a crescere',
  'tutorial.step.grow.text':
    'Ottimo! Crescere è la cosa più importante. Continua a espanderti e a conquistare altro territorio — più grande è il tuo regno, più truppe e oro avrai.',
  'tutorial.step.airport.goal': 'Costruisci un aeroporto',
  'tutorial.step.airport.text':
    "Ora tocca al potere aereo. Costruisci un aeroporto (tasto 5) — da qui partono i bombardieri. Ti diamo l'oro necessario.",
  'tutorial.step.bomber.goal': 'Lancia un bombardiere',
  'tutorial.step.bomber.text':
    'Premi il tasto 7 per costruire un bombardiere, poi clicca su un territorio nemico (grigio). Il bombardiere vola là e sgancia una bomba che uccide truppe, neutralizza il territorio e distrugge gli edifici — attenzione, non risparmia nessuno, nemmeno gli alleati.',
  'tutorial.step.finish.goal': 'Completato',
  'tutorial.step.finish.text':
    "Ce l'hai fatta! Padroneggi le basi: espanderti, conquistare, l'economia (città + fabbriche) e la guerra aerea. Porti e navi, diplomazia e modalità di gioco li imparerai meglio direttamente in una partita vera. Buona fortuna!",
  ...
  'event.tradeBlocked': 'Il tuo commercio bloccato — {amount} oro perso',
  'event.warshipSunk': 'Nave da guerra di {p} affondata',
  'event.eliminated': '{p} è stato eliminato',
  'event.capitalCaptured': '{p} conquista la capitale di {victim} e si impossessa del suo impero',
  'event.capitalBombed':
    'La capitale di {victim} è distrutta — il suo impero torna allo stato selvaggio',
  ...
  'keybind.center': 'Centra sulla tua nazione',
  'keybind.radial': 'Apri il menu azioni',
  'keybind.boat': 'Modalità barca da trasporto',
  'keybind.bomber': 'Modalità bombardiere',
  'keybind.warship': 'Modalità nave da guerra',
  'keybind.shipRanges': 'Mostra portate delle navi',
  'keybind.speedUp': 'Aumenta la velocità',
  'keybind.speedDown': 'Riduci la velocità',
  'keybind.buildCity': 'Costruisci: Città',
  'keybind.buildDefense': 'Costruisci: Difesa',
  'keybind.buildPort': 'Costruisci: Porto',
  'keybind.buildFactory': 'Costruisci: Fabbrica',
  'keybind.buildAirport': 'Costruisci: Aeroporto',
  'keybind.buildFlak': 'Costruisci: Contraerea',
  ...
  'hud.editor.tab.layout': 'Disposizione',
  'hud.editor.quickConfig': 'Config. rapida',
  ...
  'hud.editor.presets.reset': 'Ripristina',
  'hud.editor.presets.saveInto': 'Salva in…',
  'hud.editor.presets.newSlot': 'Nuovo slot',
  'hud.editor.panel.attacks': 'Attacchi in corso',
  'hud.editor.emptyHint': 'visibile in partita',
  'hud.editor.hint': 'Trascinare = sposta · Angoli = ridimensiona · × = nascondi',
  'hud.editor.resizePanel': 'Ridimensiona la barra degli strumenti',
  'hud.editor.panel.info': 'Tempo di gioco',
  'hud.editor.panel.rank': 'Classifica',
  'hud.editor.panel.resource': 'Truppe e costruzione',
  'hud.editor.panel.action': 'Barra azioni',
  'hud.editor.panel.minimap': 'Minimappa',
  'hud.editor.panel.feed': 'Messaggi',
  'hud.editor.panel.wheel': 'Ruota azioni',
  'hud.editor.panel.topbar': 'Barra di stato',
  'hud.editor.panel.attackbar': 'Dimensione attacco',
  'hud.editor.panel.menu': 'Pulsante menu',
  'hud.editor.panel.feedback': 'Pulsante feedback',
  'hud.editor.troopStyle': 'Visualizzazione truppe',
  'hud.editor.troopStyle.bar': 'Barra',
  'hud.editor.troopStyle.orb': 'Sfera',
  'hud.editor.control': 'Controlli',
  'hud.editor.control.auto': 'Auto',
  'hud.editor.control.desktop': 'Desktop',
  'hud.editor.control.touch': 'Mouse / Rotella',
  ...
  'wheel.title': 'Azioni',
  'wheel.back': 'Indietro',
  'wheel.build': 'Costruisci',
  'wheel.ships': 'Attacchi',
  'minimap.collapse': 'Comprimi minimappa',
  'minimap.expand': 'Espandi minimappa',
  'hud.boatModeHint':
  ...
  'hud.buildLevel': 'Livello',
  'hud.newMatch': 'Nuova partita',
  'hud.keepWatching': 'Continua a guardare',
  'hud.keepSpectating': 'Continua a osservare',
  'hud.defeatTitle': 'Sei stato sconfitto',
  'hud.defeatSub': 'La tua nazione è stata completamente conquistata.',
  'hud.troopStyleToggle': 'Cambia visualizzazione: barra ↔ sfera',
