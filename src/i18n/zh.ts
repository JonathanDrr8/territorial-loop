...
export const zh: Record<string, string> = {
  ...
  'camera.fixed': '边框（固定）',
  'camera.dynamic': '动态边框',
  'hovermode.both': '面板＋提示框',
  'hovermode.panel': '仅固定面板',
  'hovermode.tooltip': '仅光标提示框',
  'field.mapStyle': '地图样式',
  'mapstyle.standard': '标准',
  'mapstyle.atlas': '地图册',
  'mapstyle.flat': '简约',
  ...
  'hud.editor.presets.namePlaceholder': '名称…',
  'hud.editor.presets.reset': '重置',
