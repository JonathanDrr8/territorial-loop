...
export const zh: Record<string, string> = {
  ...
  'hud.controls': '操作',
  'hud.controlsBody':
    '左键：进攻 · B：运输艇模式（目标在其他岛屿）· 7：轰炸机模式<br/>右键：菜单（建造/进攻/运输艇/战舰/外交）<br/>拖拽（左/右）或 WASD：镜头 · 滚轮：缩放<br/>1–6：建筑（城市/防御/港口/工厂/机场/防空）· R：船只范围 · 空格：暂停<br/>, / . ：速度 · Esc：菜单<br/>点击进攻面板：取消 / 运输艇 · 召回船只',
  'hud.rank': '排行',
  'hud.troops': '兵力',
  'hud.gold': '金币',
  'hud.boat': '运输艇',
