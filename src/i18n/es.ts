...
export const es: Record<string, string> = {
  ...
  'nav.help': 'Ayuda',
  'nav.short.play': 'Jugar',
  'nav.short.multiplayer': 'Online',
  'nav.short.ranking': 'Rango',
  'nav.short.settings': 'Ajustes',
  'nav.short.changelog': 'Noticias',
  'nav.short.help': 'Ayuda',
  ...
  'field.teamMode': 'Equipos',
  'teamMode.off': 'No (todos contra todos)',
  'teamMode.allied': 'Equipos (aliados)',
  'teamMode.shared': 'Nación compartida',
  'field.teamCount': 'Número de equipos',
  'field.teamSize': 'Tamaño del equipo',
  ...
  'field.reroll': 'Tirar',
  'preset.title': 'Configuraciones',
  'preset.sub': '{ai} rivales · {wild} salvajes',
  'preset.small': 'Pequeña',
  ...
  'play.matchSettings': 'Ajustar configuración de la partida',
  ...
  // Cuenta / inicio de sesión (ADR-0027 fase 2)
  'account.signIn': 'Iniciar sesión',
  'account.title.account': 'Cuenta',
  'account.title.login': 'Iniciar sesión',
  'account.title.register': 'Crear cuenta',
  'account.title.recover': 'Restablecer contraseña',
  'account.loggedInAs': 'Sesión iniciada como {name}',
  'account.intro':
    'Opcional: guarda tu ELO en todos tus dispositivos. Sin cuenta seguirás jugando como invitado.',
  'account.username': 'Nombre de usuario',
  'account.password': 'Contraseña',
  'account.newPassword': 'Nueva contraseña',
  'account.email': 'Correo electrónico (opcional)',
  'account.recoveryCode': 'Código de recuperación',
  'account.btn.login': 'Iniciar sesión',
  'account.btn.register': 'Crear cuenta',
  'account.btn.recover': 'Restablecer',
  ...
  'account.recoveryTitle': 'Tu código de recuperación',
  'account.recoveryHint':
    'Guárdalo en un lugar seguro — es la única forma de restablecer tu contraseña sin correo electrónico. Solo se muestra esta vez.',
  'account.error.invalid': 'Nombre de usuario o contraseña incorrectos.',
  'account.error.taken': 'Ese nombre de usuario ya está en uso.',
  ...
  'help.buildings.body':
    ...
    'ataques), Puerto (comercio y barcos), Fábrica (economía), Aeropuerto (lanza bombarderos) y ' +
    'Antiaéreo (derriba bombarderos enemigos). Son mejorables; al conquistarlos, el nuevo dueño ' +
    'los conserva — salvo los puestos defensivos.',

  'help.economy.title': 'Economía (redes de fábricas)',
  'help.economy.body':
    'El oro no viene del tamaño del territorio, sino de las fábricas: una fábrica abastece tus ' +
    'ciudades y puertos que sean accesibles a través de territorio propio contiguo (las carretas ' +
    'de oro recorren tus caminos) y produce oro por cada objetivo conectado. Una fábrica cercana ' +
    'a una nación ajena rinde 3× oro (y simpatía) por ese enlace. Importante: una fábrica recién ' +
    'conquistada no produce hasta estar conectada a tus ciudades por territorio propio. ' +
    'Construye Ciudad + Puerto + Fábrica cerca y conéctalas.',
  ...
  'help.controls.body':
    ...
    'diplomacia) · 1–6: edificios · 7: bombardero · 8: buque de guerra · B: modo bote · ' +
    'R: alcances de barcos · «.» / «,»: velocidad · Espacio: pausa · Esc: menú (también «Personalizar HUD»).',
  ...
  'help.air.title': 'Guerra aérea (bombarderos y antiaéreos)',
  'help.air.body':
    'Un aeropuerto te permite lanzar bombarderos. Un bombardero vuela al objetivo y lanza una ' +
    'bomba: abre un cráter, mata tropas en el radio de explosión y deja el terreno afectado ' +
    'neutral. Esto genera mucho rencor en el objetivo (y temor en los demás). Un puesto antiaéreo ' +
    'derriba los bombarderos enemigos dentro de su alcance — úsalo para proteger tus ciudades y fábricas.',

  'help.rivers.title': 'Ríos',
  'help.rivers.body':
    'Opcional (se activa en el panel experimental o en la sala): en mapas de Continentes e Islas ' +
    'se tallan ríos reales y navegables en el terreno — desde las montañas hasta el mar. Son ' +
    'suficientemente anchos para los barcos, que así pueden adentrarse en el interior y flanquear.',

  'help.hud.title': 'Personalizar el HUD',
  'help.hud.body':
    'En una partida, pulsa Esc → «Personalizar HUD» para abrir el editor: mueve, escala y ' +
    'muestra/oculta paneles libremente (una lista muestra todos los elementos), cambia el diseño ' +
    'y restablece todo al estado predeterminado. También accesible desde los ajustes del menú ' +
    'principal. Tu disposición se guarda localmente.',

  'help.multiplayer.title': 'Multijugador y clasificatoria',
  'help.multiplayer.body':
    'Multijugador: con «Multijugador» abres una sala (comparte el código) o te unes a una — ' +
    'todos juegan sincronizados en el mismo servidor. Modo clasificatorio: solo contra una IA ' +
    'a tu nivel; si ganas, sube tu ELO para que puedas seguir tu progreso. La dificultad de la ' +
    'IA va de Principiante a Experto.',
  ...
  'event.tradeBlocked': 'Tu comercio bloqueado — {amount} oro perdido',
  'event.warshipSunk': 'Buque de guerra de {p} hundido',
  'event.eliminated': '{p} fue eliminado',
  'event.capitalCaptured': '{p} conquista la capital de {victim} y se apodera de su imperio',
  'event.capitalBombed':
    'La capital de {victim} está destruida — su imperio se convierte en tierra salvaje',
  ...
  'keybind.center': 'Centrar en tu nación',
  'keybind.radial': 'Abrir menú de acciones',
  'keybind.boat': 'Modo bote de transporte',
  'keybind.bomber': 'Modo bombardero',
  'keybind.warship': 'Modo buque de guerra',
  'keybind.shipRanges': 'Mostrar alcances de barcos',
  'keybind.speedUp': 'Aumentar velocidad',
  'keybind.speedDown': 'Reducir velocidad',
  'keybind.buildCity': 'Construir: Ciudad',
  'keybind.buildDefense': 'Construir: Defensa',
  'keybind.buildPort': 'Construir: Puerto',
  'keybind.buildFactory': 'Construir: Fábrica',
  'keybind.buildAirport': 'Construir: Aeropuerto',
  'keybind.buildFlak': 'Construir: Antiaéreo',
  ...
  'hud.editor.slider.action': 'Acciones',
  'hud.editor.slider.resource': 'Tropas',
  'hud.editor.buttons': 'Botones',
  'hud.editor.buttons.row': 'Filas',
  'hud.editor.buttons.numpad': 'Numpad',
  'hud.editor.merged': 'Bloque',
  ...
  'hud.editor.theme': 'Diseño',
  'hud.editor.hidden': 'Oculto',
  'hud.editor.elements': 'Elementos',
  'hud.editor.tab.layout': 'Disposición',
  'hud.editor.quickConfig': 'Config. rápida',
  'quickcfg.standard': 'Estándar',
  'quickcfg.mouse': 'Ratón',
  'quickcfg.wheel': 'Rueda de nav.',
  'hud.editor.presets.templates': 'Plantillas',
  'hud.editor.presets.custom': 'Propios',
  'hud.editor.presets.load': 'Cargar',
  'hud.editor.presets.save': 'Guardar',
  'hud.editor.presets.delete': 'Eliminar',
  'hud.editor.presets.slotName': 'Disposición {n}',
  'hud.editor.presets.namePlaceholder': 'Nombre…',
  'hud.editor.presets.reset': 'Restablecer',
  'hud.editor.presets.saveInto': 'Guardar en…',
  'hud.editor.presets.newSlot': 'Nueva ranura',
  'hud.editor.panel.attacks': 'Ataques en curso',
  'hud.editor.emptyHint': 'aparece en la partida',
  'hud.editor.hint': 'Arrastrar = mover · Esquinas = tamaño · × = ocultar',
  'hud.editor.resizePanel': 'Redimensionar la barra de herramientas',
  'hud.editor.panel.info': 'Tiempo de juego',
  'hud.editor.panel.rank': 'Clasificación',
  'hud.editor.panel.resource': 'Tropas y construcción',
  'hud.editor.panel.action': 'Barra de acciones',
  'hud.editor.panel.minimap': 'Minimapa',
  'hud.editor.panel.feed': 'Mensajes',
  'hud.editor.panel.wheel': 'Rueda de acción',
  'hud.editor.panel.topbar': 'Barra de estado',
  'hud.editor.panel.attackbar': 'Tamaño del ataque',
  'hud.editor.panel.menu': 'Botón de menú',
  'hud.editor.panel.feedback': 'Botón de comentarios',
  'hud.editor.troopStyle': 'Visualización de tropas',
  'hud.editor.troopStyle.bar': 'Barra',
  'hud.editor.troopStyle.orb': 'Esfera',
  'hud.editor.control': 'Controles',
  'hud.editor.control.auto': 'Auto',
  'hud.editor.control.desktop': 'Desktop',
  'hud.editor.control.touch': 'Ratón / Rueda',
  ...
  'wheel.ships': 'Ataques',
  'minimap.collapse': 'Contraer minimapa',
  ...
  'hud.defeatTitle': 'Has sido derrotado',
  'hud.defeatSub': 'Tu nación fue completamente conquistada.',
  'hud.troopStyleToggle': 'Cambiar vista: barra ↔ esfera',
  'hud.andMore': '… y {n} más',
  ...
  'field.riverDensity': 'Frecuencia de ríos',

  // ── Panel fijo de información al pasar el cursor ──────────────────────────────
  'hover.title': 'Bajo el cursor',
  'hover.empty': 'Mueve el cursor sobre el mapa',
